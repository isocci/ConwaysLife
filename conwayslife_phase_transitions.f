...
make_array_ran life_matrix          { creates initial main life matrix with random 0s and 1s}
...
: update_life		                                               	{ updates life_matrix using the rules of LIFE }
	...
	n m * m + m do	                                          		{ looping through the nxn grid for LIFE and ignoring the frame }
		n 0 do
		  ...
		  { --- Applying rules of LIFE with specified probability --- }

      100 Rnd probability < if
  			current_cell @ c@ 1 = if
